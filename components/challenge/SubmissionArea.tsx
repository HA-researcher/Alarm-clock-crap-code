...
export function SubmissionArea({ onSubmit }: SubmissionAreaProps) {
    return (
        <div className="flex items-center justify-between rounded-lg border border-[#ff4d4d]/20 bg-[#1e1e1e] p-4 text-sm font-mono text-gray-400 shadow-[0_0_30px_rgba(0,0,0,0.6)]">
            ...
            <div className="flex items-center gap-6">
                ...
                <button
                    onClick={onSubmit}
                    className="group relative overflow-hidden rounded bg-[#10b981] px-8 py-3 font-bold tracking-[0.2em] text-[#022c22] transition-all hover:bg-[#34d399] hover:shadow-[0_0_20px_rgba(16,185,129,0.5)] active:scale-95"
                >
